(function (factory) {
	...
	*/
	...
	var scrollissimo_min = createCommonjsModule(function (module, exports) {
	/**
	 * Scrollissimo
	...
	var scrollissimo = unwrapExports(scrollissimo_min);
	...
	const car = document.querySelector('.rek-car'); //242 ve 259 uda açmayı unutma
	...
	jquery(document).ready(function () {
	  ...
	  let videoHole = jquery('.video-hole');
	  let videoHoleheight = parseFloat(jquery(videoHole).css('width')) / 1.8;
	  jquery(videoHole).css('height', videoHoleheight + 'px');
	...
	function scrollanim() {
	  ...
	  const sectiontitles = jquery(".rek-section-title").toArray();
	  sectiontitles.forEach(function (titleElement) {
	    ...
	    let titleIn = TweenLite.to(document.getElementById(titleElement.id), rekTitleDuration, {
	      left: `${screenWidth / 2 - rekTitleWidth / 2}px`
	    });
	    let titleFade = TweenLite.to(document.getElementById(titleElement.id), rekTitleDuration / 2, {
	      opacity: 1
	    });
	    let titleOut = TweenLite.to(document.getElementById(titleElement.id), rekTitleDuration, {
	      opacity: 0
	    });
	  ...
	  let divyTween = TweenLite.to(document.getElementById('rekSection1Content'), rekSection1Duration, {
	    scale: 1
	  });
	  let divyTween1 = TweenLite.to(document.getElementById('rekSection1Content'), rekSection1Duration, {
	    scale: 0
	  });
	  let divyTween2 = TweenLite.to(document.getElementById('rekSection1Content'), rekSection1Duration, {
	    opacity: 1
	  });
	  let divyTween3 = TweenLite.to(document.getElementById('rekSection1Content'), rekSection1Duration, {
	    opacity: 0
	  });
	  ...
	  let divyTween4 = TweenLite.to(document.getElementById('rekSection2Content'), rekSection2Duration, {
	    scale: 1
	  });
	  let divyTween5 = TweenLite.to(document.getElementById('rekSection2Content'), outDuration, {
	    scale: 0
	  });
	  let divyTween6 = TweenLite.to(document.getElementById('rekSection2Content'), rekSection2Duration, {
	    opacity: 1
	  });
	  let divyTween7 = TweenLite.to(document.getElementById('rekSection2Content'), outDuration, {
	    opacity: 0
	  });
